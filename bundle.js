...
/***/ function(module, exports, __webpack_require__) {
	...
	var _numeral = __webpack_require__(162);
	...
	var App = function (_Component) {
	  ...
	  _createClass(App, [{
	    ...
	    value: function handleIncrement() {
	      ...
	      counter++;
	      this.setState({ counter: counter });
	      UserInfo.getInfo(function (user) {
	        socket.emit('incrementCounter', { counter: counter, user: user });
	      }, function (err) {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            'h2',
	            null,
	            'So far, Trump has been shaken ' + (0, _numeral2.default)(this.state.counter).format('0,0') + ' times.'
	          )
	        )
	      );
	    }
